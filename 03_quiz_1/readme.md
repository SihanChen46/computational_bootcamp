...
__Any material is fair-game. All quizzes are cumulative.__

More effective ways of studying
------

1. Make and use flashcards for concepts and coding problems.
2. Take a coding problem from class or homework solve it completely on your own by writing the code from scratch. 
    ...
    - Double check your solution. Refactor to be elegant.
3. Take a concept from class and create a mind-map.
